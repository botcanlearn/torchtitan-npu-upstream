...
"""DeepSeek-V4.1 sparse-attention override: the fused SMLA core.

The LightningIndexer half lives in its own package, :mod:`...deepseek_v4_1.lightning_indexer`,
so the two can be selected independently.
"""
